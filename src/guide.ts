...
| rename a board | \`rename_board {boardId, title}\` |
| tidy existing boards into folders | \`move_board_to_folder {boardId, folderId}\` (\`folderId: null\` takes it out) |
